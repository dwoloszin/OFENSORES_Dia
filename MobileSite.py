...
def processArchive():
    fields = ['REGIONAL','LOCATION','NAME','SITE_TYPE','PROVISIONSTATUS','LATITUDE','LONGITUDE','ANF','MUNICIPIO','IBGE_ID','ANTENA_SYS_CLASS','INSTALL']
    fields2 = ['REGIONAL','LOCATION','NAME','SITE_TYPE','NGNIS','LAT','LONG','ANF','CIDADE','IBGE_ID','ANTENA_SYS_CLASS','INSTALL']
    Folder = 'MOBILESITE'
    ...
    frameSI['NAME'] = frameSI['NAME'].str.strip()
